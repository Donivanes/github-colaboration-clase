    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Welcome to the about page</h1>
            <p className="text-xl mb-8">We are going to colaborate</p>
      ...
      <section className="bg-gray-100 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to merge?</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Be careful with conflicts</p>
